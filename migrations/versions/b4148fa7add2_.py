...
Revision ID: b4148fa7add2
Revises: 
Create Date: 2025-02-14 16:34:12.231579
...
def upgrade():
    ...
    sa.Column('create_invoice_status', sa.String(length=20), nullable=False),
    sa.Column('manage_operation_status', sa.String(length=20), nullable=False),
    sa.Column('items_access_status', sa.String(length=20), nullable=False),
    sa.Column('machine_access_status', sa.String(length=20), nullable=False),
    sa.Column('mechanism_access_status', sa.String(length=20), nullable=False),
    sa.Column('supplier_access_status', sa.String(length=20), nullable=False),
